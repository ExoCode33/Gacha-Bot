...
class EnhancedTurnBasedPvP {
    ...
    async createSimpleBattleInvitation(interaction, battleId, challenger, target, challengerData, targetData, challengerFruits, targetFruits) {
        try {
            ...
            await this.sendPrivateMessage(target, challenger, battleId, 'target');
    ...
    // FIXED: Send private message with correct Discord user object
    async sendPrivateMessage(player, opponent, battleId, playerRole) {
        try {
            const embed = new EmbedBuilder()
                ...
                .addFields([
                    ...
                    { 
                        ...
                        value: 'If both players accept, you\'ll enter fruit selection phase, then strategic turn-based combat!', 
                        inline: false 
                    }
                ])
