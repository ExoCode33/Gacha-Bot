// src/systems/pvp/npc-bosses.js - One Piece NPC Boss System
    ...
    selectBattleFruit(npcData, availableFruits, turn, enemyFruits, balancedCP) {
        ...
        const scoredFruits = availableFruits.map(fruitName => {
            ...
            try {
                ...
                // Fallback scoring based on name patterns
                if (fruitName.includes('Mythical') || fruitName.includes('Phoenix')) score = 6;
                else if (fruitName.includes('Legendary') || fruitName.includes('Gura')) score = 5;
                else if (fruitName.includes('Logia') || fruitName.includes('Magu')) score = 4;
            }
